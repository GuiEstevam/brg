    ...
    <div class="row g-4">
      ...
      <div class="col-md-6 form-floating">
        <select name="enterprise_id" id="enterprise_id" class="form-select @error('enterprise_id') is-invalid @enderror"
          ...
          @foreach ($enterprises as $enterprise)
            <option value="{{ $enterprise->id }}" @selected(old('enterprise_id', $branch->enterprise_id ?? request('enterprise_id')) == $enterprise->id)>
              {{ $enterprise->name }}
            </option>
          @endforeach
        </select>
      ...
      <div class="col-md-6 form-floating">
        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name"
          placeholder="Nome" value="{{ old('name', $branch->name ?? '') }}" required autocomplete="off">
      ...
      <div class="col-md-6 form-floating">
        <input type="text" class="form-control @error('city') is-invalid @enderror" name="city" id="city"
          placeholder="Cidade" value="{{ old('city', $branch->city ?? '') }}" required>
      ...
      <div class="col-md-3 form-floating">
        <input type="text" class="form-control @error('uf') is-invalid @enderror" name="uf" id="uf"
          placeholder="UF" value="{{ old('uf', $branch->uf ?? '') }}" required maxlength="2"
      ...
      <div class="col-md-3 form-floating">
        <input type="text" class="form-control @error('cep') is-invalid @enderror" name="cep" id="cep"
          placeholder="CEP" value="{{ old('cep', $branch->cep ?? '') }}">
      ...
      <div class="col-md-6 form-floating">
        <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" id="address"
          placeholder="Endereço" value="{{ old('address', $branch->address ?? '') }}">
      ...
      <div class="col-md-3 form-floating">
        <input type="text" class="form-control @error('district') is-invalid @enderror" name="district"
          id="district" placeholder="Bairro" value="{{ old('district', $branch->district ?? '') }}">
      ...
      <div class="col-md-3 form-floating">
        <input type="text" class="form-control @error('number') is-invalid @enderror" name="number" id="number"
          placeholder="Número" value="{{ old('number', $branch->number ?? '') }}">
      ...
      <div class="col-md-3 form-floating">
        <input type="text" class="form-control @error('complement') is-invalid @enderror" name="complement"
          id="complement" placeholder="Complemento" value="{{ old('complement', $branch->complement ?? '') }}">
