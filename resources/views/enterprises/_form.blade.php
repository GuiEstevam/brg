<div class="d-flex justify-content-center">
  <div class="p-4 p-md-5 rounded-4 w-100">
    <p class="text-muted">Preencha os dados abaixo para
      {{ isset($enterprise) && $enterprise->exists ? 'editar' : 'criar' }} a empresa.</p>
    <div class="row g-4">
      <div class="col-md-6 form-floating">
        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name"
          placeholder="Nome" value="{{ old('name', $enterprise->name ?? '') }}" required autocomplete="off">
      ...
      <div class="col-md-6 form-floating">
        <input type="text" class="form-control @error('cnpj') is-invalid @enderror" name="cnpj" id="cnpj"
          placeholder="CNPJ" value="{{ old('cnpj', $enterprise->cnpj ?? '') }}" required autocomplete="off">
      ...
      <div class="col-md-6 form-floating">
        <input type="text" class="form-control @error('state_registration') is-invalid @enderror"
          name="state_registration" id="state_registration" placeholder="Inscrição Estadual"
          value="{{ old('state_registration', $enterprise->state_registration ?? '') }}">
      ...
      <div class="col-md-6 form-floating">
        <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" id="address"
          placeholder="Endereço" value="{{ old('address', $enterprise->address ?? '') }}" required>
      ...
      <div class="col-md-4 form-floating">
        <input type="text" class="form-control @error('number') is-invalid @enderror" name="number" id="number"
          placeholder="Número" value="{{ old('number', $enterprise->number ?? '') }}" required>
      ...
      <div class="col-md-4 form-floating">
        <input type="text" class="form-control @error('uf') is-invalid @enderror" name="uf" id="uf"
          placeholder="UF" value="{{ old('uf', $enterprise->uf ?? '') }}" required maxlength="2"
      ...
      <div class="col-md-4 form-floating">
        <input type="text" class="form-control @error('complement') is-invalid @enderror" name="complement"
          id="complement" placeholder="Complemento" value="{{ old('complement', $enterprise->complement ?? '') }}">
      ...
      <div class="col-md-4 form-floating">
        <input type="text" class="form-control @error('cep') is-invalid @enderror" name="cep" id="cep"
          placeholder="CEP" value="{{ old('cep', $enterprise->cep ?? '') }}" required>
      ...
      <div class="col-md-4 form-floating">
        <input type="text" class="form-control @error('district') is-invalid @enderror" name="district"
          id="district" placeholder="Bairro" value="{{ old('district', $enterprise->district ?? '') }}" required>
      ...
      <div class="col-md-4 form-floating">
        <input type="text" class="form-control @error('city') is-invalid @enderror" name="city" id="city"
          placeholder="Cidade" value="{{ old('city', $enterprise->city ?? '') }}" required>
      ...
      <div class="col-md-6 form-floating">
        <input type="text" class="form-control @error('responsible_name') is-invalid @enderror"
          name="responsible_name" id="responsible_name" placeholder="Responsável"
          value="{{ old('responsible_name', $enterprise->responsible_name ?? '') }}">
      ...
      <div class="col-md-6 form-floating">
        <input type="email" class="form-control @error('responsible_email') is-invalid @enderror"
          name="responsible_email" id="responsible_email" placeholder="Email do Responsável"
          value="{{ old('responsible_email', $enterprise->responsible_email ?? '') }}">
      ...
      <div class="col-md-6 form-floating">
        <input type="text" class="form-control @error('responsible_phone') is-invalid @enderror"
          name="responsible_phone" id="responsible_phone" placeholder="Telefone do Responsável"
          value="{{ old('responsible_phone', $enterprise->responsible_phone ?? '') }}">
